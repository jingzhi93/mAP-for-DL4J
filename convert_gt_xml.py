...
# this script converts the VOC-format annotation(ground truth) into the format suitable for the mAP repo at Cartucho/mAP
import sys
import os
import glob
...
# change directory to the your folder path with all the files to be changed
GT_PATH = os.path.join(os.getcwd(), 'data','test')
os.chdir(GT_PATH)
